...
<h1>👁️ Eye Tracker - Отвлекся и отвернулся? Теперь будешь вынужден не отворачиваться!</h1>
    ...
    <blockquote>
        ...
        - Всё упаковано в один <code>.exe</code> — никаких установок Python или дополнительных библиотек на компьютере жертвы не требуется</p>
    </blockquote>
    <hr>
